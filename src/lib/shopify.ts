...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "sleep-soundly-fx5oi-fwrhqntx.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "2909a2c925d4b7ca460fd17285ad7da2";
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Zahlung erforderlich", {
      description:
        "Der Shopify-API-Zugriff erfordert einen aktiven Shopify-Tarif. Besuche https://admin.shopify.com, um zu upgraden.",
    });
    return null;
  }
...
export async function fetchProducts(first = 10, query?: string) {
